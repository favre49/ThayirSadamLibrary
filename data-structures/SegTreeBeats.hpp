...
struct SegTreeBeats {
  public:
    ...
    // range add query
    void add_val(int a, int b, int64_t x) {
      _add_val(x, a, b, 0, 0, sz-1);
    }
    // range update query
    ...
    // range minimum query
    int64_t query_max(int a, int b) {
      return _query_max(a, b, 0, 0, sz-1);
    }
    // range maximum query
    int64_t query_min(int a, int b) {
      return _query_min(a, b, 0, 0, sz-1);
    }
    // range sum query
    int64_t query_sum(int a, int b) {
      return _query_sum(a, b, 0, 0, sz-1);
    }
